...
signal dialogue_line_advanced(dialogue_id: StringName, line_index: int)
signal dialogue_choice_highlighted(dialogue_id: StringName, choice_index: int)
signal dialogue_choice_confirmed(dialogue_id: StringName, choice_index: int)
